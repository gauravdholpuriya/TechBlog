        ...
        <main class="primary-background banner-background" style="padding-bottom:50px ">
            <div class="container">
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card">
                            <div class="car-header primary-background text-white text-center ">
                               ...
                               <form id="reg-form" action="RegisterServlet" method="POST">
                                  ...
                                  <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <input type="radio" id="gendar" name="gender" value="male">male
                                    <input type="radio" id="gendar" name="gender" value="female">Female
                                  </div>
